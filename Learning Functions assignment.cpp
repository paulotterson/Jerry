...
#include <iostream>
#include <string>
//This will pull the funtions over from the header and use add them into this code without having everything on one page. 
#include "Header.h"
...
int main()
{
	//This is calling on of the functions that are in the header file
	Intro();
	...
	//This is calling the last function that is in the Header file.
	endline();
